...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.78'; }, 
        @{ModuleName = 'PSWriteHTML'; GUID = 'a7bdf640-f5cb-4acf-9de0-365b322d245c'; ModuleVersion = '0.0.38'; })
    ...
    FunctionsToExport = 'EmailHTML', 'EmailList', 'EmailListItem', 'EmailTable', 'EmailText', 
    'EmailTextBox', 'EmailAttachment', 'EmailBCC', 'EmailCC', 'EmailFrom', 
    'EmailOptions', 'EmailReplyTo', 'EmailServer', 'EmailSubject', 'EmailTo', 
