...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSSharedGoods'; GUID = 'ee272aa8-baaa-4edf-9f45-b6d6f7d844fe'; ModuleVersion = '0.0.83'; }, 
        @{ModuleName = 'PSWriteHTML'; GUID = 'a7bdf640-f5cb-4acf-9de0-365b322d245c'; ModuleVersion = '0.0.47'; })
    ...
    'EmailHeader', 'EmailHTML', 'EmailList', 'EmailListItem', 'EmailOptions', 
    'EmailReplyTo', 'EmailServer', 'EmailSubject', 'EmailText', 
    'EmailTextBox', 'EmailTo'
