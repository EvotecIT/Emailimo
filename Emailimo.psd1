...
FunctionsToExport = 'EmailHeading', 'EmailHTML', 'EmailList', 'EmailListItem', 'EmailTable', 
               'EmailText', 'EmailTextBox', 'EmailAttachment', 'EmailBCC', 'EmailCC', 
               'EmailFrom', 'EmailOptions', 'EmailReplyTo', 'EmailServer', 
               'EmailSubject', 'EmailTo', 'Email', 'EmailBody', 'EmailHeader'
